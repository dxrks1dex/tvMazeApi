...
const HeaderStyled = styled.header<{ isScrolled: boolean }>`
  position: sticky;
...
const HomeIcoStyled = styled.div`
  svg {
    width: 30px;
    height: 30px;
    &:hover {
...
const HeaderButtonsStyled = styled.button`
    ...
    <HeaderStyled isScrolled={isScrolled}>
      <HeaderNavigationBar>
        ...
        <HeaderButtonsContainer>
          <HeaderButtonsStyled onClick={() => back()}>Back</HeaderButtonsStyled>
          <HeaderButtonsStyled onClick={() => forward()}>
            Forward
          </HeaderButtonsStyled>
        </HeaderButtonsContainer>
      </HeaderNavigationBar>
